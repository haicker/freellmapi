...
export default function PlaygroundPage() {
  ...
  // ordered BY INTELLIGENCE — the manual 智能值 (1–100) directly, HIGHER = smarter
  // (convention flipped 2026-07), name as the final tiebreaker. The size_label
  // tier no longer influences ordering.
  const pickerOptions = [
    ...
    ...modelOptions
      .slice()
      .sort((a, b) =>
        b.intelligenceRank - a.intelligenceRank ||
